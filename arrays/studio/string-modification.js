...
userInput = input.question("How many letters would you like to relocate?");//remove to run
//1) Use string methods to remove the first three characters from the string and add them to the end.
//Hint - define another variable to hold the new string or reassign the new string to str.
strCut = str.slice(userInput,3); //(0, 3)
strCutTwo = str.slice(3, userInput); //(3, 10)

combinedString = [strCut, strCutTwo];
finalStr = combinedString.reverse().join("");
